      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <div className="relative inline-block mb-6">
            <h2 className="text-6xl md:text-7xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent animate-gradient-x leading-tight">
              Manifest Dreams
            </h2>
          ...
          <CardContent className="relative z-10">
            {!isAddingItem ? (
              ...
              <div className="space-y-6 animate-fade-in-up">
                ...
                <div className="relative">
                  <Textarea
                    placeholder="🌟 Paint your vision with words... Be specific, be bold, be magical!"
